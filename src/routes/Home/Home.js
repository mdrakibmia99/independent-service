        ...
        <section className='overflow-hidden'>
            ...
            <section className='container mx-auto my-5'>
                ...
                <div className='ms-1 p-3 bg-light '>
                        <img  src={thumb2} alt="thumbnail-2" className='w-100 img-fluid' />
                    ...
                    <div className='me-1 p-3 bg-light '>
                        <img src={thumb3} alt="thumbnail-3" className='w-100 img-fluid'/>
                    ...
                    <div className='p-3 bg-light rounded'>
                        <img src={thumb1} alt="thumbnail-1" className='w-100 img-fluid'/>
